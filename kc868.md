...
1. [Página Inicial](https://www.kincony.com/)
2. [Guia do Usuário](https://www.kincony.com/user-guide)
3. Como usar o firmware “KCS” v2...

**Nota:** Este documento é destinado ao controlador inteligente KinCony:  
KC868-AM, ASR, A2, A4, A4S, A6, A8, A8M, A8S, A16, A16S, E16S, A32, A32M, A64, A128, AG, AK, AI, AIO, AP.

Se preferir ler em PDF, [faça o download do guia do usuário](https://www.kincony.com/images/user-guide/KCS_V2/KCS_user_guide_v2.0.pdf).
